                                ...
                                <div class="row">
                                    ...
                                    <div class="col-9">
                                        <a class="btn btn-primary btn-flat btn-sm  float-right"
                                            href="{{ route('vendors.ven-details.ven-post.create', ['id' => $id, 'name' => $name]) }}">Add Vendor Product </a>
                                    </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('vendors.ven-details.ven-post.delete', ['id' => $prod->prod_id, 'vendor_id' => $id, 'name' => $name])}}"><i
