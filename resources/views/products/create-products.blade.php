                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control select2" name="prod-cat" id="prod-cat"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control select2" name="prod-subcat"
                                                        id="prod-subcat" style="width: 100%;" required>
                                                        <option selected="">Please Select</option>
                                                        @foreach ($subcategory as $subcat )

                                                        <option value="{{$subcat->sub_id}}">{{$subcat->subcat_name}}
                                                        </option>
                                                        @endforeach
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="product-price"
                                                name="product-price" placeholder="Enter product price">
                                        </div>
                                        <!-- /.card-body -->
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="product-sku"
                                                        name="product-sku" placeholder="Enter product price">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" id="product-price"
                                                        name="product-stock" placeholder="Enter product stock">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" id="product-main-image" name="product-main-image"
                                                        placeholder="Choose your image" required>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control select2" name="vendor" id="vendor"
                                                        ...
                                                        <option value="{{$ven->vendorID}}">
                                                            {{$ven->vendor_business_name}}</option>
                                                        @endforeach
