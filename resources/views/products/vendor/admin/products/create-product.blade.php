            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active">Create Vendor Product</li>
                </ol>
              </div><!-- /.col -->
            </div><!-- /.row -->
          </div><!-- /.container-fluid -->
            ...
            <div class="container-fluid">
              <section class="content">
                  ...
                  <div class="card card-primary">
                      ...
                      <!-- /.card-header -->
                      <!-- form start -->
                      <form role="form" action="{{ route('vendors.ven-details.ven-post.add', ['id' => $id , 'name' => $name]) }}" method="post" enctype="multipart/form-data">
                          @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <label for="description-prod">Product Excerpt</label>
                                ...
                                <!-- /.card-header -->
                                  ...
                                  <div class="mb-3">
                                    <textarea class="textarea" placeholder="Place some text here" rows="6" cols="50"
