            ...
            <div class="row">
                <div class="col-12 col-sm-6">
                    ...
                    <div class="col-12">
                        ...
                        <img src="{{ url('storage/main-images/'.$prod->product_main_image) }}" class="product-image"
                            alt="Product Image">
                        @endforeach
                    ...
                    <div class="col-12 product-image-thumbs">
                        ...
                        <div class="product-image-thumb active"> <img
                            src="{{ url('storage/main-images/'.$prod->product_main_image) }}" class="product-image"
                        ...
                        <div class="product-image-thumb ">
                            <img
                                src="{{ url('storage/main-images/product-gallery/'.$gal->product_img) }}" class="product-image"
                                alt="Product Image"></div>
                        @endforeach
